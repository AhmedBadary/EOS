...
window.onload = function(){
    ...
    var radius = 30;
  	terrain = "forest_";
  	if (sessionStorage.getItem("arctic_terrain")) {
      terrain = sessionStorage.getItem("arctic_terrain");
    }
    if (sessionStorage.getItem("arctic_color_count")) {
      colorCount = JSON.parse(sessionStorage.getItem("arctic_color_count"));
    }
    if (sessionStorage.getItem("arctic_count")) {
      console.log(sessionStorage.getItem("arctic_count"));
      radius = 10 * parseInt(sessionStorage.getItem("arctic_count"));
    } else {
      console.log("hi");
      sessionStorage.setItem("arctic_count", "3");
    }
  	if (mood !== null && mood !== "null") {
  	  ...
  	  sessionStorage.setItem("arctic_terrain", terrain);
  	  sessionStorage.setItem("arctic_count", (parseInt(sessionStorage.getItem("arctic_count")) + 1) + '');
  	  sessionStorage.setItem("arctic_color_count", JSON.stringify(colorCount));
  	  console.log(radius);
